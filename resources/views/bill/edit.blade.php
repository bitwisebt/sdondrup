...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Update Billing - Payment</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row justify-content-center">
                <div class="col-md-11">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('billing.update',$bill->id)}}">
                                @csrf
                                @method('PUT')
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="expense" id="expense" class="form-control select2" required autofocus>
                                            ...
                                            <option value="{{$data->id}}" {{$data->id==$bill->expense_id?'selected':''}}>{{$data->expense}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="customer" id="customer" class="form-control select2" required>
                                            ...
                                            <option value="{{$data->id}}" {{$data->id==$bill->billing_id?'selected':''}}>{{$data->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <input value="{{$bill->bill_number}}" id="bill_number" type="text" class="form-control" name="bill_number" required>
                                    </div>
                                    <label for="group" class="col-md-2 col-form-label text-md-right">{{ __('Bill Date') }}</label>
                                    <div class="col-md-2">
                                        <input value="{{$bill->bill_date}}" id="bill_date" type="date" class="form-control" name="bill_date" required>
                                    </div>
                                    <label for="group" class="col-md-2 col-form-label text-md-right">{{ __('Due Date') }}</label>
                                    <div class="col-md-2">
                                        <input value="{{$bill->due_date}}" id="due_date" type="date" class="form-control" name="due_date" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="group" class="col-md-2 col-form-label text-md-right">{{ __('Narration') }}</label>
                                    <div class="col-md-6">
                                        <textarea name="remarks" id="remarks" required class="form-control" placeholder="Bill Details">{{$bill->remarks}}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <select name="flag" id="flag" class="form-control" required>
                                            <option value="">Select</option>
                                            <option value="P" {{$bill->flag=='P'?'selected':''}}>Pending</option>
                                            <option value="C" {{$bill->flag=='C'?'selected':''}}>Paid</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row" id="hide" hidden>
                                    ...
                                    <div class="col-md-4">
                                        <select name="payment_mode" id="payment_mode" class="form-control">
                                            <option value="">Select</option>
                                            <option value="B" {{$bill->payment_mode=='B'?'selected':''}}>Bank</option>
                                            <option value="C" {{$bill->payment_mode=='C'?'selected':''}}>Cash</option>
                                            <option value="D" {{$bill->payment_mode=='D'?'selected':''}}>Cheque</option>
                                        </select>
                                    </div>
                                    <label for="group" class="col-md-2 col-form-label text-md-right">{{ __('Payment Date') }}</label>
                                    <div class="col-md-4">
                                        <input value="{{$bill->payment_date}}" id="payment_date" type="date" class="form-control" name="payment_date">
                                    </div>
                                </div>
                                <hr>
                                        ...
                                        <table class="table table-sm" width="100%" id="tblItem">
                                            ...
                                            <tbody class="addMoreProduct">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input value="{{$data->description}}" id="description" type="text" required class="form-control description" name="description[]">
                                                    </td>

                                                    <td>
                                                        <input value="{{$data->rate}}" onClick="this.select();" id="rate" type="number" required step="0.01" class="form-control rate" name="rate[]" autocomplete="off" style="width: 120px !important; min-width: 120px; max-width: 120px;">
                                                    </td>
                                                    <td>
                                                        <input value="{{$data->quantity}}" onClick="this.select();" id="quantity" type="number" required step="0.01" class="form-control quantity" name="quantity[]" autocomplete="off" style="width: 120px !important; min-width: 120px; max-width: 120px;">
                                                    </td>
                                                    <td>
                                                        <input value="{{$data->amount}}" id="amount" type="text" class="form-control amount" name="amount[]" readonly style="width: 90px !important; min-width: 90px; max-width: 90px;">
                                                    </td>
                                                    <td></td>
                                                </tr>
                                                @endforeach
                                    ...
                                    <div class="table-responsive col-md-5 offset-md-7">
                                        <table class="noBorder table-sm justify-content-md-center">
                                            ...
                                            <tr>
                                                    ...
                                                    <td>
                                                        <input onClick="this.select();" id="tax" type="number" value="{{$bill->tax??0}}" class="form-control" step="0.01" name="tax" onkeyup="totalAmount()">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right"><small><b>Total</b></small></td>
                                                    <td>
                                                        <input id="total" type="number" readonly value="{{$bill->amount}}" class="form-control" step="0.01" name="total">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="tax_total" type="number" readonly value="{{$bill->tax_amount}}" class="form-control" step="0.01" name="tax_total">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="grand_total" type="number" readonly value="{{$bill->total}}" class="form-control" step="0.01" name="grand_total">
