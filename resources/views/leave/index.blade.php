                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle white-space-nowrap text-center pe-0">
                                            @can('Year Leave edit')
                                            <a class="btn btn-sm btn-phoenix-primary me-1 fs--2 " href="{{route('generate-leave.view',$data)}}">Balance/Update</a>
                                            @endcan
                                            @can('Year Leave create')
                                            <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('leave.history',$data)}}">History</a>
                                            @endcan
                                        </td>
