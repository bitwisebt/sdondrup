    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Leave Generated History</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/home">Home</a></li>
                            <li class="breadcrumb-item active">Generate Leave</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Leave Generated Details</h3>
                
                <div class="card-tools">
                    @can('Year Leave edit')
                    <button type="button" class="btn btn-sm btn-phoenix-info me-1 fs--2" data-toggle="modal" data-target="#remove"><i class="fa fa-plus text-success" aria-hidden="true"></i> Generate</button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are you sure you want to generate leave to employees?
                                </div>
                                <div class="modal-footer">
                                    <a class="btn btn-sm btn-primary text-white" href="{{url('/leave-generated/generate')}}"> Yes </a>
                            ...
                            <table class="table table-sm fs--1 mb-0" id="myTable" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort border-top" data-sort="name">Generated By</th>
                                    </tr>
                                </thead>
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle name">{{$data->generated_by}}</td>
