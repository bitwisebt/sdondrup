            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-success btn-sm" href="{{route('income.create')}}"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                        <li class="nav-item"><a class="nav-link active" href="/income">All income <span class="text-700 fw-semi-bold">({{$income_all}})</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="/income?archive">View Archived income <span class="text-700 fw-semi-bold">({{$income_count}})</span></a></li>
                    </ul>
                            ...
                            <table class="table table-sm fs--1 mb-0" id="myTable" width="60%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort border-top" data-sort="name">Income</th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle white-space-nowrap text-center pe-0">
                                            ...
                                            @else
                                            @can('Department edit')
                                            <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('income.edit',$data)}}"><span class="fas fa-edit"></span></a>
                                            @endcan
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-sm btn-danger text-white" href="{{route('income.destroy',$data->id)}}"> Yes </a>
