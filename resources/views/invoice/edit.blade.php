...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Invoice - Update</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('invoice.update',$invoice->id)}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="customer" id="customer" class="form-control select2" required disabled>
                                            <option value="">Select</option>
                                            @foreach($customer as $data)
                                            <option value="{{$data->id}}" {{$data->id==$invoice->customer_id?'selected':''}}>{{$data->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input value="{{$invoice->invoice_date}}" id="invoice_date" type="date" class="form-control" name="invoice_date" required>
                                    </div>
                                    <label for="group" class="col-md-2 col-form-label text-md-right">{{ __('Due Date') }}</label>
                                    <div class="col-md-4">
                                        <input value="{{$invoice->due_date}}" id="due_date" type="date" class="form-control" name="due_date" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="group" class="col-md-2 col-form-label text-md-right">{{ __('Narration') }}</label>
                                    <div class="col-md-6">
                                        <textarea name="remarks" id="remarks" required class="form-control" placeholder="Invoice Details">{{$invoice->remarks}}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <select name="flag" id="flag" class="form-control" required>
                                            <option value="">Select</option>
                                            <option value="P" {{$invoice->flag=='P'?'selected':''}}>Pending</option>
                                            <option value="C" {{$invoice->flag=='C'?'selected':''}}>Paid</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row" id="hide" hidden>
                                    ...
                                    <div class="col-md-4">
                                        <select name="payment_mode" id="payment_mode" class="form-control">
                                            <option value="">Select</option>
                                            <option value="B" {{$invoice->payment_mode=='B'?'selected':''}}>Bank</option>
                                            <option value="C" {{$invoice->payment_mode=='C'?'selected':''}}>Cash</option>
                                            <option value="D" {{$invoice->payment_mode=='D'?'selected':''}}>Cheque</option>
                                        </select>
                                    </div>
                                    <label for="group" class="col-md-2 col-form-label text-md-right">{{ __('Payment Date') }}</label>
                                    <div class="col-md-4">
                                        <input value="{{$invoice->payment_date}}" id="payment_date" type="date" class="form-control" name="payment_date">
                                    </div>
                                </div>
                                <hr>
                                        ...
                                        <table class="table table-sm" width="100%" id="tblItem">
                                            ...
                                            <tbody class="addMoreProduct">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="description" type="text" required class="form-control description" name="description[]" value="{{$det->description}}">
                                                    </td>

                                                    <td>
                                                        <input onClick="this.select();" id="rate" type="number" required step="0.01" class="form-control rate" name="rate[]" value="{{$det->rate}}" autocomplete="off" style="width: 160px !important; min-width: 160px; max-width: 160px;">
                                                    </td>
                                                    <td>
                                                        <input onClick="this.select();" id="quantity" type="number" required step="0.01" class="form-control quantity" name="quantity[]" value="{{$det->quantity}}" autocomplete="off" style="width: 90px !important; min-width: 90px; max-width: 90px;">
                                                    </td>
                                                    <td>
                                                        <input id="amount" type="text" class="form-control amount" name="amount[]" value="{{$det->amount}}" readonly style="width: 160px !important; min-width: 160px; max-width: 160px;">
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                    ...
                                    <div class="table-responsive col-md-5 offset-md-7">
                                        ...
                                        <tbody class="foot">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input onClick="this.select();" id="tax" type="number" value="{{$invoice->tax??0}}" class="form-control" step="0.01" name="tax" onkeyup="totalAmount()">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="total" type="number" readonly value="{{$invoice->amount}}" class="form-control" step="0.01" name="total">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="tax_total" type="number" readonly value="{{$invoice->tax_amount}}" class="form-control" step="0.01" name="tax_total">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="grand_total" type="number" readonly value="{{$invoice->total}}" class="form-control" step="0.01" name="grand_total">
