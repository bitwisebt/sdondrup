            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-success btn-sm" href="{{route('agent.create')}}"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                        <li class="nav-item"><a class="nav-link active" href="/agent">All Agent <span class="text-700 fw-semi-bold">({{$agent_all}})</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="/agent?archive">View Archived Agent <span class="text-700 fw-semi-bold">({{$agent_count}})</span></a></li>
                    </ul>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle white-space-nowrap text-center pe-0">
                                            ...
                                            @else
                                            @can('Agent edit')
                                            <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('agent.edit',$data)}}"><span class="fas fa-edit"></span></a>
                                            @endcan
                                            @can('Agent delete')
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-sm btn-danger text-white" href="{{route('agent.destroy',$data->id)}}"> Yes </a>
