                            ...
                            <div class="row">
                                <div class="col-md-2" style="padding-left: 15px;">
                                    <ul class="nav nav-pills nav-pills-icons flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#enrolment" id="enr" role="tab" data-toggle="tab">
                                                Enrolment
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="col-md-10">
                                    <form class="custom-form" id="contactForm" method="POST" role="form" action="{{route('registration.store')}}">
                                        @csrf
                                                ...
                                                <div class="row ">
                                                    <div class="col-4">
                                                        ...
                                                        <select name="type" id="type" class="form-control" required>
                                                            ...
                                                            <option value="Onshore" {{old('type')=='Onshore'?'selected':''}}>Onshore</option>
                                                            <option value="Offshore" {{old('type')=='Offshore'?'selected':''}}>Offshore</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-4">
                                                        ...
                                                        <select name="registration_type" id="registration_type" class="form-control" required>
                                                            <option value="">Select</option>
                                                            <option value="EV" {{old('registration_type')=='EV'?'selected':''}}>Enrolment & VISA</option>
                                                            <option value="E" {{old('registration_type')=='E'?'selected':''}}>Enrolment Only</option>
                                                            <option value="V" {{old('registration_type')=='V'?'selected':''}}>VISA only</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-4">
                                                ...
                                                <div class="row ">
                                                    <div class="col-8">
                                                        ...
                                                        <select class="form-control" name="name" id="name" required>
                                                            ...
                                                            <option value="{{$std->name}}" data-price="{{$std->id}}" {{old('name')==$std->name?'selected':''}}>{{$std->name}}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <select class="form-control" name="marital_status" id="marital_status" required>
                                                            <option value="">Select</option>
                                                            <option value="M" {{old('marital_status')=='M'?'selected':''}}>Married</option>
                                                            <option value="S" {{old('marital_status')=='S'?'selected':''}}>Single</option>
                                                            <option value="D" {{old('marital_status')=='D'?'selected':''}}>Divorce</option>
                                                            <option value="W" {{old('marital_status')=='W'?'selected':''}}>Widow</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input class="form-control" type="text" name="passport_no" id="passport_no" placeholder="Passport No." required />
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="fieldlabels">Issue Date: *</label>
                                                        <input class="form-control" type="date" name="issue_date" id="issue_date" required />
                                                    </div>
                                                    <div class="col-3">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select class="form-control qualification" name="qualification[]" id="qualification" required autofocus>
                                                                    ...
                                                                    <option value="{{$qui->id}}">{{$qui->qualification}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <input class="form-control school_name" type="text" name="school_name[]" id="school_name" placeholder="College/School Name" required />
                                                            </td>
                                                            <td>
                                                                <input class="form-control course_name" type="text" name="course_name[]" id="course_name" placeholder="Name of course" required />
                                                            </td>
                                                            <td>
                                                                <input class="form-control completion_date" type="number" name="completion_date[]" id="completion_date" min="1990" max="{{date('Y')}}" autocomplete="off" />
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <button class="form-control btn btn-primary next-button" id="h1" hidden data-target="#proficiency">Next</button>
                                                <button class="form-control btn btn-primary next-button" id="h2" data-target="#enrolment">Next</button>
                                            </div>
                                            <!-----------Enrolment----------->
                                            <div class="tab tab-pane reg" id="enrolment">
                                                <table id="table" class="table table-bordered table-sm" style="font-size: 90.5%;">
                                                    ...
                                                    <tbody class="addMoreEnrolment" id="EnrolmentTable">
                                                        <tr>
                                                            <td>
                                                                <select class="form-control" name="enrolment" id="enrolment">
                                                                    <option value="">Select</option>
                                                                    @foreach($enrol as $enr)
                                                                    <option value="{{$enr->id}}" {{old('enrolment')==$enr->id?'selected':''}}>{{$enr->enrolment}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select class="form-control" name="organization" id="organization">
                                                                    ...
                                                                    <option value="{{$uni->id}}" {{old('organization')==$enr->id?'selected':''}}>{{$uni->university}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <input class="form-control course" type="text" name="course" id="course" placeholder="Name of course" />
                                                            </td>
                                                            <td>
                                                                <input class="form-control start" type="month" name="start" id="start" />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <select class="form-control" name="test" id="test" required>
                                                            <option value="">Select</option>
                                                            @foreach($test as $tt)
                                                            <option value="{{$tt->id}}" {{old('test')==$tt->id?'selected':''}}>{{$tt->sht_name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="fieldlabels">Score Band: *</label>
                                                        <input class="form-control" type="number" step="0.01" name="total" id="total" placeholder="Score Band" required autocomplete="off" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <input class="form-control" type="number" step="0.01" name="listening" id="listening" placeholder="Listening Score" autocomplete="off" required />
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="fieldlabels">Reading: *</label>
                                                        <input class="form-control" type="number" step="0.01" name="reading" id="reading" placeholder="Reading Score" autocomplete="off" required />
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="fieldlabels">Speaking: *</label>
                                                        <input class="form-control" type="number" step="0.01" name="speaking" id="speaking" placeholder="Speaking Score" autocomplete="off" required />
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="fieldlabels">Writing: *</label>
                                                        <input class="form-control" type="number" step="0.01" name="writing" id="writing" placeholder="Writing Score" autocomplete="off" required />
                                                    </div>
                                                    <br>
                                                </div>
                                                <br>
                                                <button class="form-control btn btn-primary next-button" data-target="#agent">Next</button>
                                            </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select class="form-control" name="super_agent" id="super_agent" required>
                                                                    <option value="">Select</option>
                                                                    @foreach($agent as $sa)
                                                                    <option value="{{$sa->id}}" {{$sa->id==old('super_agent')?'selected':''}}>{{$sa->agent}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select class="form-control" name="sub_agent" id="sub_agent" required>
                                                                    ...
                                                                    <option value="{{$sua->id}}" {{$sua->id==old('sub_agent')?'selected':''}}>{{$sua->agent}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="tab tab-pane reg" id="emergency">
                                                ...
                                                <table id="table" class="table table-bordered table-sm">
                                                    ...
                                                    <tbody class="addMoreTravel" id="TravelTable">
                                                        <tr>
                                                            <td>
                                                                <input class="form-control emergency_name" type="text" name="emergency_name[]" id="emergency_name" placeholder="Contact Person name" />
                                                            </td>
                                                            <td>
                                                                <select class="form-control relation" name="relation[]" id="relation">
                                                                    <option value="">Select</option>
                                                                    @foreach($relation as $rel)
                                                                    <option value="{{$rel->id}}" {{old('relation')==$rel->id?'selected':''}}>{{$rel->relation}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <input class="form-control emergency_contact_no" type="text" name="emergency_contact_no[]" id="emergency_contact_no" placeholder="Contact Number" />
                                                            </td>
                                                            <td>
                                                                <input class="form-control emergency_email" type="text" name="emergency_email[]" id="emergency_email" placeholder="Email" />
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                    </tbody>
