                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form class="custom-form" id="contactForm" method="POST" role="form" action="{{route('new-application.store')}}">
                                @csrf
                                    ...
                                    <div class="tab tab-pane active border reg" id="personal">
                                        <div class="row ">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" name="contact_number" id="contact_number" class="form-control" placeholder="Phone/Mobile number" required />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-3">
                                                ...
                                                <select class="form-control" name="qualification" id="qualification" required>
                                                    ...
                                                    <option value="{{$quli->id}}" {{old('qualification')==$quli->id?'selected':''}}>{{$quli->qualification}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-3">
                                                <label class="fieldlabels">Completion Year: *</label>
                                                <input type="text" class="form-control" name="year" id="year" placeholder="Year of Completion" required />
                                            </div>
                                            <div class="col-3">
                                                <label class="fieldlabels">English Test: *</label>
                                                <select class="form-control" name="test" id="test" required>
                                                    <option value="">Select</option>
                                                    <option value="Y" {{old('test')=='Y'?'selected':''}}>Yes</option>
                                                    <option value="N" {{old('test')=='N'?'selected':''}}>No</option>
                                                </select>
                                            </div>
                                            <div class="col-3">
                                                ...
                                                <select class="form-control" name="employment" id="employment" required>
                                                    <option value="">Select</option>
                                                    <option value="Y" {{old('employement')=='Y'?'selected':''}}>Yes</option>
                                                    <option value="N" {{old('employement')=='N'?'selected':''}}>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <br>
