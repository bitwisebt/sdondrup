            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-sm btn-phoenix-danger " href="{{route('admission-document.complete',$id)}}"><i class="fa fa-save text-primary" aria-hidden="true"></i> Complete</a>
                    </div>
                </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a class="btn btn-sm btn-danger text-white" href="{{url('/admission-document/delete/'.$std->id.'/'.$std->student_id)}}"> Yes </a>
