                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/finance-payroll">Payroll</a></li>
                        ...
                        <table class="table table-sm fs--1 mb-0" id="myTable" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort border-top">Desig.</th>
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle white-space-nowrap text-center pe-0">
                                        @if($check->flag=='A')
                                        <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{url('finance-payroll/adjust/'.$data->id)}}"><span class="fas fa-plus text-info"></span>Adjust/deduct</a>
                                        @endif
                                        &nbsp;
                                        <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('finance-payroll.payslip',$data->id)}}" target="_blank"><span class="fas fa-print text-primary"></span></a>
                                    </td>
