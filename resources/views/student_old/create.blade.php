                            ...
                            <div class="row">
                                <div class="col-md-2" style="padding-left: 15px;">
                                    <ul class="nav nav-pills nav-pills-icons flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#enrolment" role="tab" data-toggle="tab">
                                                Enrolment
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <form class="custom-form" id="contactForm" method="POST" role="form" action="{{route('registration.store')}}">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab tab-pane reg" id="qualification">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select class="form-control qualification" name="qualification[]" id="qualification" required autofocus>
                                                                    ...
                                                                    <option value="{{$qui->id}}" {{old('qualification')==$qui->id?'selected':''}}>{{$qui->qualification}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td>
                                                ...
                                                <button class="form-control btn btn-primary next-button" data-target="#enrolment">Next</button>
                                            </div>
                                            <!-----------Enrolment----------->
                                                ...
                                                <table id="table" class="table table-bordered table-sm" style="font-size: 90.5%;">
                                                    ...
                                                    <tbody class="addMoreEnrolment" id="EnrolmentTable">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control course" type="text" name="course" id="course" placeholder="Name of course" required />
                                                            </td>
                                                            <td>
                                                                <input class="form-control start" type="month" name="start" id="start" required />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
