                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-header">
                            {{ __('Student Summary by Status') }}
                        </div>

                        <div class="card-body">
                            <form method="POST" action="{{route('student-registration.status')}}" target="_blank">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label for="Course" class="col-md-3 col-form-label text-md-right">{{ __('Status: ') }}</label>
                                    <div class="col-md-9">
