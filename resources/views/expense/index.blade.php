            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-success btn-sm" href="{{route('expense.create')}}"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                        <li class="nav-item"><a class="nav-link active" href="/expense">All expense <span class="text-700 fw-semi-bold">({{$expense_all}})</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="/expense?archive">View Archived expense <span class="text-700 fw-semi-bold">({{$expense_count}})</span></a></li>
                    </ul>
                            ...
                            <table class="table table-sm fs--1 mb-0" id="myTable" width="60%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort border-top" data-sort="name">Expense</th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle name">{{$data->expense}}</td>
                                        
                                        <td class="align-middle white-space-nowrap text-center pe-0">
                                            @if($data->trashed())
                                            @can('Department restore')
                                            <form method="POST" action="{{route('expense.restore',$data->id)}}">
                                                @csrf
                                                <button class="btn btn-sm btn-outline-secondary me-1 mb-1 fs--2" type="submit">Restore</button>
                                            </form>
                                            @endcan
                                            @can('Department delete forever')
                                            <form action="{{route('expense.force_delete',$data->id)}}" method="POST">
                                                @csrf
                                            ...
                                            @else
                                            @can('Department edit')
                                            <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('expense.edit',$data)}}"><span class="fas fa-edit"></span></a>
                                            @endcan
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-sm btn-danger text-white" href="{{route('expense.destroy',$data->id)}}"> Yes </a>
