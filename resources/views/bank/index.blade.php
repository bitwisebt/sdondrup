            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-success btn-sm" href="{{route('bank.create')}}"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                        <li class="nav-item"><a class="nav-link active" href="/bank">All Bank <span class="text-700 fw-semi-bold">({{$bank_all}})</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="/bank?archive">View Archived Bank <span class="text-700 fw-semi-bold">({{$bank_count}})</span></a></li>
                    </ul>
                            ...
                            <table class="table table-sm fs--1 mb-0" id="myTable" width="60%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort border-top" data-sort="name">Bank</th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle name">{{$data->bank}}</td>
                                        
                                        <td class="align-middle white-space-nowrap text-center pe-0">
                                            @if($data->trashed())
                                            @can('Bank restore')
                                            <form method="POST" action="{{route('bank.restore',$data->id)}}">
                                                @csrf
                                                <button class="btn btn-sm btn-outline-secondary me-1 mb-1 fs--2" type="submit">Restore</button>
                                            </form>
                                            @endcan
                                            @can('Bank delete forever')
                                            <form action="{{route('bank.force_delete',$data->id)}}" method="POST">
                                                @csrf
                                            ...
                                            @else
                                            @can('Bank edit')
                                            <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('bank.edit',$data)}}"><span class="fas fa-edit"></span></a>
                                            @endcan
                                            @can('Bank delete')
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-sm btn-danger text-white" href="{{route('bank.destroy',$data->id)}}"> Yes </a>
