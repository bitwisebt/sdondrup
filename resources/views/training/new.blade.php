            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-success btn-sm" href="{{route('generate-leave.add',$id)}}"><i class="fa fa-plus"></i> Apply</a>
                        <a class="btn btn-info btn-sm" href="/generate-leave"><i class="fa fa-backward"></i> Back</a>
                    </div>
                </div>
                <div class="card-body">
