            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-success btn-sm" href="{{route('department.create')}}"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                        <li class="nav-item"><a class="nav-link active" href="/department">All department <span class="text-700 fw-semi-bold">({{$department_all}})</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="/department?archive">View Archived department <span class="text-700 fw-semi-bold">({{$department_count}})</span></a></li>
                    </ul>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle white-space-nowrap text-center pe-0">
                                            ...
                                            <form method="POST" action="{{route('department.restore',$data->id)}}">
                                                @csrf
                                                <button class="btn btn-sm btn-outline-secondary me-1 mb-1 fs--2" type="submit">Restore</button>
                                            </form>
                                            @endcan
                                            @can('Department delete forever')
                                            <form action="{{route('department.force_delete',$data->id)}}" method="POST">
                                                @csrf
                                            ...
                                            @else
                                            @can('Department edit')
                                            <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('department.edit',$data)}}"><span class="fas fa-edit"></span></a>
                                            @endcan
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-sm btn-danger text-white" href="{{route('department.destroy',$data->id)}}"> Yes </a>
