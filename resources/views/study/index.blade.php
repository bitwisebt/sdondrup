        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Study List</h3>

                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                        <a class="btn btn-success btn-sm" href="{{route('study.create')}}"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                        <li class="nav-item"><a class="nav-link active" href="/study">All Study <span class="text-700 fw-semi-bold">({{$study_all}})</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="/study?archive">View Archived Study <span class="text-700 fw-semi-bold">({{$study_count}})</span></a></li>
                    </ul>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle white-space-nowrap text-center pe-0">
                                            ...
                                            @else
                                            @can('Study edit')
                                            <a class="btn btn-sm btn-phoenix-info me-1 fs--2 " href="{{route('study.edit',$data)}}"><span class="fas fa-edit"></span></a>
                                            @endcan
                                            @can('Study delete')
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-sm btn-danger text-white" href="{{route('study.destroy',$data->id)}}"> Yes </a>
