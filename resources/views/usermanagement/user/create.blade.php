                    ...
                    <form class="row" method="POST" action="{{route('user.store')}}">
                        ...
                        <div class="col-6">
                            ...
                            <select name="employee_id" id="employee_id" class="form-control" required onchange="showPrice()" >
                                ...
                                <option data-price="{{$data->email}}" value="{{$data->id}}" {{old('employee_id')==$data->id?'selected':''}}>{{$data->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-6">
                            ...
                            <input onfocus="this.select();" class="form-control" id="password" name="password" type="password" value="" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label" for="role">Confirm Password</label>
                            <input onfocus="this.select();" class="form-control" id="confirm_password" name="confirm_password" type="password" required>
                        </div>
                        <br>
